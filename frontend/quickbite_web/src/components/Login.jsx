      ...
      <section className="login">
        <div className="container">
          <div className="flex justify-center items-center gap-x-[50px] border-2 border-[#808080]  rounded-2xl bg-opacity-90 shadow-2xl  px-[39px] py-[45px] absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2  w-[1000px] ">
            <div className=" ">
              ...
              <form className="mt-[36px] block" onSubmit={handleSubmit}>
                ...
                <input
                  ...
                  className="border border-[#808080] block w-full py-[12px] px-[11px] text-[16px] outline-none rounded-[10px] mt-[28px]   focus:outline-none focus:ring-2 focus:ring-blue-500 font-[500] placeholder:font-[500]"
                ...
                <p className="text-center font-[500]">
                  Create an account?{" "}
                  <Link className="text-[#2F89FC] font-[500] hover:underline hover:underline-offset-4" to="/signup">
                    Signup
                  </Link>
                </p>
              </form>
            ...
            <div>
              <img className="rounded-2xl" src={assets.food_bg} alt="background image" />
            </div>
          </div>
        </div>
      </section>
